...
const exactPhrasePairs: Array<[string, string]> = [
  ...
  ['Open Markdown', 'Ouvrir le Markdown'],
  ['Sections', 'Sections'],
  ['Loading user guide...', 'Chargement du guide utilisateur...'],
  [
    'A plain-language guide for every OLYVIA user role, including patients, clinicians, reception, courier, laboratory, reporting, finance, admin, and super-admin workflows.',
    "Un guide en langage simple pour chaque role utilisateur d'OLYVIA, y compris les patients, cliniciens, reception, coursier, laboratoire, rapports, finance, administration et workflows super administrateur.",
  ],
  ['Settings', 'Parametres'],
