...
const exactPhrasePairs: Array<[string, string]> = [
  ...
  ['All your tests with OLYVIA. Click an order for details, timeline, results, and payment.', 'Toutes vos analyses chez OLYVIA. Cliquez sur une commande pour voir les details, le suivi, les resultats et le paiement.'],
