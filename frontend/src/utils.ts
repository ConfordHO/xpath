...
export async function downloadPdfDocument(
  ...
  const footer = options.footer ?? 'PathNovate - Center for Molecular Pathology and Genomics'
  pdf.setFontSize(9)
...
const reportCopy = {
  en: {
    ...
    signout: 'SIGN-OUT',
    authenticity:
      'This result was electronically generated by PathNovate. Scan the QR code or open the validation link to confirm authenticity.',
    validationLink: 'Validation link',
    generatedBy: 'END OF REPORT - Generated by PathNovate',
  ...
  fr: {
    ...
    signout: 'VALIDATION',
    authenticity:
      "Ce resultat a ete genere electroniquement par PathNovate. Scannez le QR code ou ouvrez le lien de validation pour verifier son authenticite.",
    validationLink: 'Lien de validation',
    generatedBy: 'FIN DU RAPPORT - Genere par PathNovate',
