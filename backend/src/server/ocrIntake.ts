...
function testSearchTerms(testType: Database["testTypes"][number]) {
  ...
  const synonymMap: Record<string, string[]> = {
    "test-biopsy": ["biopsy", "biopsie", "histology", "histologie", "h&e", "hematoxylin"],
    "test-resection": ["resection", "piece operatoire", "surgical specimen", "histopathology"],
    "test-pap": ["pap", "cervical", "cervix", "col uterus", "papanicolaou"],
    "test-body-fluids": ["fluid", "fluids", "cytology", "cytologie", "ascites", "pleural"],
    "test-tumor-ihc": ["ihc", "immunohistochemistry", "immunophenotyping", "tumor subtyping"],
    "test-pdl1": ["pd-l1", "pdl1", "pd l1"],
    "test-bcr-abl": ["bcr", "abl", "bcr-abl", "molecular", "pcr"],
    "test-tumor-marker": ["tumor marker", "marqueurs", "blood marker"],
    "test-peripheral-blood": ["peripheral blood", "blood cytology", "sang peripherique"],
    "test-bone-marrow-cytology": ["bone marrow cytology", "moelle", "myelogram"],
    "test-bone-marrow-histology": ["bone marrow biopsy", "trephine", "osteomedullaire"],
  };
